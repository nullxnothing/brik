...
- `02_product_build_spec.md` — PRD, architecture, AI agent, security, and build roadmap.
- `03_ui_ux_brand_spec.md` — product UX, workspace layout, design system, and landing page.
