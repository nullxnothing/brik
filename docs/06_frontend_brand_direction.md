...
1. Navigation
2. Hero + product demo
3. Building blocks / core capabilities
4. Workflow: WRITE → TEST → BUILD → DEPLOY
5. Large interactive product preview
6. Technical proof / compatibility
7. Example projects — real user-built apps opening to live previews with fork buttons
8. Final CTA: **Start building.**
9. Minimal footer
...
## Responsive behavior
Desktop is expansive and grid-based. Mobile stacks modules naturally instead of preserving every desktop panel simultaneously.
...
- Does this feel modular?
- Does this feel precise?
- Would a serious developer tool do this?
